...
namespace CortanaWorld
{
	...
	public sealed partial class MainPage : Page
	{
		...
		protected override void OnNavigatedTo(NavigationEventArgs e)
		{
            ...
            var speech = new Plugin.Windows10.VoiceSpeech();
            Windows10Interop.SpeechRequested += speech.StartListening;
            Windows10Interop.StopSpeechRequested += speech.StopListening;
        }
